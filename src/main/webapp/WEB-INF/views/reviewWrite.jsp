		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a class="btn_back" title="이전 화면으로 이동" onclick="goback()"> <i class="fn fn-backward1"></i> </a>
					<h2><span class="title">${product.productDescription}</span></h2>
				</div>
				
				<form method="POST" action="upload" enctype="multipart/form-data" id="review_form">
				
				<!-- reservationInfoId, productId 값 임시 보관 -->
				<input class="inputReservationInfoId" value="${reservationInfoId}" name="reservationInfoId" style="display:none">
				<input class="inputProductId" value="${productId}" name="productId" style="display:none">
				...
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating">
							...
							<input type="checkbox" name="rating" value="1" class="rating_rdo" title="1점">
							<span class="span"></span>
							<input type="checkbox" name="rating" value="2" class="rating_rdo" title="2점">
							<span class="span"></span>
							<input type="checkbox" name="rating" value="3" class="rating_rdo" title="3점" >
							<span class="span"></span>
							<input type="checkbox" name="rating" value="4" class="rating_rdo" title="4점">
							<span class="span"></span>
							<input type="checkbox" name="rating" value="5" class="rating_rdo" title="5점">
							<span class="span"></span>
				...
				<div class="review_contents write">
					...
					<textarea cols="30" rows="10" class="review_textarea" name="reviewTextarea"></textarea>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" name="imageFile" accept="image/png, image/jpeg">
						<div class="guide_review">
							<span class="content_length">0</span>/400
							<span>(최소5자이상)</span>
						</div>
					</div>
					...
					<div class="warning_div" style="display:none">
						<span class="warning_space" style="color:red;"></span>
					</div>
					<!-- 경고 표시 -->
				...
				<!-- 리뷰 등록 -->
				<div class="box_bk_btn" onclick="submit();">
