            ...
            <div class="wrap_review_list">
                <div class="review_header">
                    <div class="top_title gr">
                        ...
                        <h2><a class="title" href="#">${displayInfo.productDescription}</a></h2>
                    </div>
                </div>
                <div class="section_review_list">
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area"> <span class="graph_mask"> <em class="graph_value" style="width: 88%;"></em> </span> <strong class="text_value"> <span><fmt:formatNumber value="${commentAvgScore}" pattern="0.#"/></span> <em class="total">5.0</em> </strong>
