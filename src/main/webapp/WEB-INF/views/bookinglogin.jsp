               ...
               <div class="booking_login">
                  ...
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="myreservation" method="post">
                        ...
                        <button type="submit" form="form1" class="login_btn confirm" onclick="login()"> <span translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button> <!----> <!----> <!----> <!----> 
                     </form>
                  </div>
                  <section class="result" style="color:red; text-align: center;">
