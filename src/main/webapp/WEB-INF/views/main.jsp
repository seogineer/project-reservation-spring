...
<body>
            ...
            <div class="section_visual">
                <div class="group_visual">
                    <div class="container_visual">
                        ...
                        <div>
                            <div class="container_visual slide_container">
                                <!-- 슬라이딩기능: 이미지 (type = 'th')를 순차적으로 노출 -->
                                <ul class="visual_img">
                                <c:forEach items="${promotionList}" var="promotion">
                                	<li class="item promotionItem" style="background-image: url(img/${promotion.productImageUrl});">
            ...
            <div class="section_event_tab">
                <ul class="event_tab_lst tab_lst_min">
                    <li class="item" data-category="0">
                        <a class="anchor active"> <span onclick="tabClick(this)">전체리스트</span> </a>
                    </li>
                    <c:forEach items="${categoryList}" var="category">
	                <li class="item" data-category="${category.id}">
			        	<a class="anchor"> <span onclick="tabClick(this)">${category.name}</span> </a>
			        </li>
			        </c:forEach>
                </ul>
            </div>
                ...
                <div class="wrap_event_box">
                    ...
                    <c:forEach items="${productList}" var="product" varStatus="status">
	                    <c:if test="${status.index%2 == 0}">
		                    <li class="item">
					            <a href="detail/${product.displayInfoId}?productId=${product.productId}" class="item_book">
					                <div class="item_preview">
					                    <img alt="${product.productDescription}" class="img_thumb" src="img/${product.productImageUrl}">
                    ...
                    <c:forEach items="${productList}" var="product" varStatus="status">
                    	<c:if test="${status.index%2 != 0}">
		                    <li class="item">
					            <a href="detail/${product.productId}?productId=${product.productId}" class="item_book">
					                <div class="item_preview">
					                    <img alt="${product.productDescription}" class="img_thumb" src="img/${product.productImageUrl}">
					                    <span class="img_border"></span>
					                </div>
                    ...
                    <!-- 더보기 -->
                    <div class="more">
                        <button id="moreBtn" class="btn" onclick="moreBtn()"><span>더보기</span></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="rv-template" id="itemList">
        <li class="item">
            <a href="detail/{displayInfoId}?productId={productId}" class="item_book">
                <div class="item_preview">
    ...
    <script type="rv-template" id="categoryList">
        <li class="item" data-category="{id}">
        	<a class="anchor"> <span>{category}</span> </a>
        </li>
    </script>
