			...
			<div class="section_my">
				...
				<div class="my_summary">
					<ul class="summary_board">
						...
						<li class="item">
							<a href="#" class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em> <span class="figure">${validCount}</span> </a>
						</li>
						<li class="item">
							<a href="#" class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span class="figure">${invalidCount}</span> </a>
						</li>
						<li class="item">
							<a href="#" class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em class="tit">취소·환불</em> <span class="figure">${cancelCount}</span> </a>
						</li>
					</ul>
				</div>
				<!--// 예약 현황 -->
				...
				<div class="wrap_mylist">
					<ul class="list_cards">
						<!--[D] 예약확정: .confirmed, 취소된 예약&이용완료: .used 추가 card -->
							...
							<c:if test="${reservation.cancelFlag == 0}">
										...
										<div class="card_body">
											...
											<div class="middle">
												<div class="card_detail">
													<em class="booking_number">No.<fmt:formatNumber value="${reservation.reservationInfoId}" pattern="0000000" /></em>
													<h4 class="tit">${reservation.description }</h4>
													<ul class="detail">
														<li class="item">
															<span class="item_tit">일정</span>
															<em class="item_dsc">
																${reservation.openingHours}
															</em>
														</li>
														<li class="item">
															<span class="item_tit">내역</span>
															<em class="item_dsc">
																<fmt:formatDate value="${reservation.reservationDate}" pattern="yyyy.MM.dd.(E)" />
															</em>
														</li>
														<li class="item">
													...
													<div class="booking_cancel">
														<a href="myreservation/${reservation.reservationInfoId}?cancelYn=2&email=${reservation.reservationEmail}&productId=${reservation.productId}"><button class="btn"><span>이용 완료 및 리뷰 남기기</span></button></a>
														<a href="myreservation/${reservation.reservationInfoId}?cancelYn=1&email=${reservation.reservationEmail}&productId=${reservation.productId}"><button class="btn"><span>취소</span></button></a>
													</div>
						...
						<c:forEach items="${reservationList}" var="reservation">
						<c:if test="${reservation.cancelFlag == 2}">	
						<li class="card used">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
						...
						<c:forEach items="${reservationList}" var="reservation">
						<c:if test="${reservation.cancelFlag == 1}">	
